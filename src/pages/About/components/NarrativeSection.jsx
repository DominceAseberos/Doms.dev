            ...
            <div className="flex flex-col lg:grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                ...
                <div className="order-2 lg:order-1 lg:col-span-4 lg:sticky lg:top-32 w-full">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-8 lg:gap-0 lg:space-y-12">
                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">Location</p>
                        ...
                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">Social</p>
                            <div className="flex flex-row flex-wrap gap-x-6 gap-y-3">
                                {[
                                    ...
                                    <a 
                                        key={link.name}
                                        href={link.url} 
                                        className="text-lg lg:text-3xl text-white/90 hover:text-[#c8ff3e] transition-all duration-300 flex items-center group"
                                    >
                                        {link.name}
                        ...
                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">Capabilities</p>
                            <div className="flex flex-wrap gap-2 text-xs lg:text-base">
                                {['Creative Development', 'Interaction Design', 'Technical Architecture', 'Custom Animation', 'Full-stack'].map(item => (
                                    <span key={item} className="px-3 lg:px-5 py-1.5 lg:py-2.5 bg-white/5 border border-white/10 rounded-full text-gray-300 hover:bg-white/10 hover:border-white/20 transition-colors duration-300 cursor-default font-medium">{item}</span>
                                ))}
                            </div>
                        </div>

                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">AI-Augmented Stack</p>
                            <div className="flex flex-wrap gap-2 text-xs lg:text-base">
                                {['GPT-4o', 'Claude 3.7', 'Gemini', 'Cursor', 'Perplexity'].map(tool => (
                                    <span key={tool} className="px-3 lg:px-5 py-1.5 lg:py-2.5 bg-[#c8ff3e]/5 border border-[#c8ff3e]/10 rounded-full text-white/90 flex items-center gap-2 backdrop-blur-md hover:bg-[#c8ff3e]/10 hover:border-[#c8ff3e]/20 transition-colors duration-300 cursor-default font-medium">
                        ...
                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">Design & UI/UX</p>
                            <div className="flex flex-wrap gap-2 text-xs lg:text-base">
                        ...
                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">Motion & SVG</p>
                            <div className="flex flex-wrap gap-2 text-xs lg:text-base">
                        ...
                        <div className="space-y-4">
                            <p className="text-[#c8ff3e] ui-sub-label text-base uppercase tracking-widest opacity-60">Assets & Optimization</p>
                            <div className="flex flex-wrap gap-2 text-xs lg:text-base">
